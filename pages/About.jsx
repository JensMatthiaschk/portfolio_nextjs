    ...
    return (
        <>
            <section id={t('about:section_title')} ref={aboutRef}
                className="font-Sarala flex h-fit sm:h-screen lg:ml-36 lg:pl-4 sm:ml-20 px-8 mb-20 flex-col justify-center overflow-hidden"
            >
                ...
                <p className="text-sm sm:text-lg my-8 font-medium lg:w-[80%] w-[90%]">{t("about:description")}</p>
