    ...
    return (
        <>
            <section id={t('about:section_title')} ref={aboutRef}
                className={`font-Sarala flex h-fit sm:h-screen lg:w-[70%] w-[80%] mx-auto z-0 flex-col justify-center items-start overflow-hidden max-w-[1600px] animate-fade-in select-none`}
            >
